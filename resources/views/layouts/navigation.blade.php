<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @elseif($role === 'employee')
                        <x-nav-link :href="route('employee.cars.index')" :active="request()->routeIs('employee.cars.*')">
                            {{ __('Cars') }}
                        </x-nav-link>
                    @else
                        <x-nav-link :href="route('user.cars.index')" :active="request()->routeIs('user.cars.*')">
                            {{ __('Cars') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif($role === 'employee')
                <x-responsive-nav-link :href="route('employee.cars.index')" :active="request()->routeIs('employee.cars.*')">
                    {{ __('Cars') }}
                </x-responsive-nav-link>
            @else
                <x-responsive-nav-link :href="route('user.cars.index')" :active="request()->routeIs('user.cars.*')">
                    {{ __('Cars') }}
                </x-responsive-nav-link>
